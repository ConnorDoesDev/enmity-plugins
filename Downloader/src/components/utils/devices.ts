...
async function get_device_list() {
  try {
    ...
    let res = await REST.get(
      `https://gist.githubusercontent.com/adamawolf/3048717/raw/1ee7e1a93dff9416f6ff34dd36b0ffbad9b956e9/Apple_mobile_device_types.txt`
    );
    ...
    console.warn(
      `[SpinsPlugins Local Error — Issue when getting devices: ${err}]`
    );
